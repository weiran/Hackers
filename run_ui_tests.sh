...
FULL_TESTS=(
  ...
  CommentingUITests/testEmptyCollapsedComposerShowsCommentIconAndPlaceholder
  CommentingUITests/testCollapsedComposerUsesTwentyFourPointScreenMargins
  CommentingUITests/testExpandedComposerRestoresOriginalKeyboardMargin
  CommentingUITests/testComposerKeyboardUsesReturnKey
  ...
  CommentingUITests/testCollapsedReplyLabelKeepsCardTopInset
  CommentingUITests/testDirtyReplySwitchPreservesDraftWithoutConfirmation
  ...
  CommentingUITests/testCustomBrowserCollapsedComposerUsesTwentyFourPointScreenMargins

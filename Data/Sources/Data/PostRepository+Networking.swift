...
extension PostRepository {
    ...
    internal func fetchPostsHtml(type: PostType, page: Int, nextId: Int) async throws -> String {
        let url: URL
    ...
    internal func hackerNewsURL(id: Int, page: Int) -> URL? {
